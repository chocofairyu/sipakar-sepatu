...
:root {
    ...
    --danger-fg:    #9B1C1C;
    --radius:       10px;
    --shadow:       0 2px 12px rgba(13,92,74,0.08);
}
...
h2 { font-size: 1.75rem !important; font-weight: 600 !important; color: var(--primary) !important; }
...
if halaman == "🔍 Konsultasi":
    st.title("Konsultasi Pencucian Sepatu")
    st.markdown(
        '<p style="font-size: 19px;color:#4A6157;margin-top:-0.4rem">'
        'Masukkan informasi sepatu Anda untuk mendapatkan rekomendasi metode pencucian '
        'berdasarkan metode <strong>Certainty Factor (CF)</strong>.</p>',
        unsafe_allow_html=True,
    )
    st.markdown("---")
